...
import { createContact, getContactById, updateContact } from '../../../actions/contactsApi';
...
const EditContactModal = () => {
  ...
  useEffect(() => {
    dispatch(getContactById({id: contact.id, setUser}));
  }, []);
    ...
    <div className={styles.overlay}>
      <div className={styles.modal}>
        <div className={styles.containerModal}>
          <h2 className={styles.titleModal}>Редактировать контакт</h2>
          { user !== null ? <>
            <form>
            ...
            <div className={styles.buttonBlock}>
              <button 
                ...
                onClick={() => {
                  if (checkFormValid()) {
                    dispatch(updateContact({ id: contact.id, name, phoneNumber, company, role, comment, photos }));
                    dispatch(closeModal());
                  }
                }}
              >
